...
2. **按主题定位文档**：
 ...
 - **模型定义(Transformers)**:Qwen3 `nn.Module`/HF config/decoder/model/causal-lm 分层 → `docs/research/transformers/overview.md`
   ...
   - **NVIDIA CMX**(G3.5 / DOCA Memos 双端 KV 设备 / NVMe-KV 128-bit key / NIXL prestaging；VAST DASE/CNode 为伙伴落法) → `docs/research/nvidia-cmx.md`（公开材料+GTC S81773/S82255+NIXL 插件；仿真 `tools/cmx-sim/`）

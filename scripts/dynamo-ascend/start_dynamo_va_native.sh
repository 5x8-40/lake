...
#   - bash scripts/dynamo-ascend/start_etcd.sh   # skip if DISCOVERY=file
...
#   ETCD_ENDPOINTS=http://10.x.x.x:2379 bash scripts/dynamo-ascend/start_dynamo_va_native.sh
#   WM_ROOT=/data/wm bash scripts/dynamo-ascend/start_dynamo_va_native.sh
#
# Verify:
#   curl -s localhost:8000/v1/models
#
# Logs: $WM_ROOT/dynamo-native-logs/{frontend,worker}.log
# Stop:  bash scripts/dynamo-ascend/start_dynamo_va_native.sh stop
set -euo pipefail

...
> 首次 clone 后执行 `git submodule update --init --recursive` 拉取 `3rdparty/`。参考项目与本系统设计的逐层对应见 [`docs/research/3rdparty-reference.md`](docs/research/3rdparty-reference.md)。
>

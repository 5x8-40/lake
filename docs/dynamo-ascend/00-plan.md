...
| 仓 | 放什么 |
|----|--------|
| [5x8-40/dynamo-ascend](https://github.com/5x8-40/dynamo-ascend) **`release/1.4.2`** | 1.4.2 交付线（[`PR #3`](https://github.com/5x8-40/dynamo-ascend/pull/3) 已合入：`MooncakeConnectorV1` 协议 + Kunpeng `generic`） |
...
- 源码：`5x8-40/dynamo-ascend` @ **`release/1.4.2`**

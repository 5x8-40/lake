...
- [nvidia-cmx.md](nvidia-cmx.md) — **NVIDIA CMX**:DOCA Memos 双端 KV I/O、KV volume、128-bit key、context hole；**VAST** GTC S82255 / DASE CNode 为公开最完整的伙伴落法与长上下文容量表；非 submodule；仿真 `tools/cmx-sim/`

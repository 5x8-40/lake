...
- **NVIDIA CMX** (Inference Context Memory Storage / ICMS): Vera Rubin POD 上的 G3.5 以太网闪存上下文存储（BlueField-4 STX、DOCA KV I/O、NIXL prestaging）。公开材料分析见 [`nvidia-cmx.md`](nvidia-cmx.md)；定量仿真见 [`../../tools/cmx-sim/`](../../tools/cmx-sim/)。

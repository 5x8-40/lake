...
- **HBM 归属与卸载路径**：Dynamo G1 是引擎页句柄而非池；Router event、本机 G2/G3 lookup、NIXL 注册是三件事；与 LMCache / HiCache / vLLM `kv_offload` / UCM 对照，以及「一份 radix」对 F4 的含义。见 [`hbm-tier-and-offload.md`](hbm-tier-and-offload.md)。

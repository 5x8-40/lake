...
[vllm-project/production-stack](https://github.com/vllm-project/production-stack) 是 vLLM 项目下的 K8s 分布式部署栈,其请求路由器(`vllm_router`)的 `routing_logic.py` 实现了多种策略:
